const OPP_SOURCES = [
  { id: 'scholars4dev', name: 'Scholars4Dev', type: 'RSS', url: 'https://www.scholars4dev.com/feed/', kind: 'scholarship', free: true },
  { id: 'opportunitydesk_fellowships', name: 'Opportunity Desk (Fellowships)', type: 'RSS', url: 'https://opportunitydesk.org/category/fellowships/feed/', kind: 'fellowship', free: true },
  ...
  { id: 'oppsforyouth', name: 'Opportunities For Youth', type: 'RSS', url: 'https://opportunitiesforyouth.org/feed/', kind: 'mixed', free: true },
  { id: 'nsf_funding', name: 'NSF Funding', type: 'RSS', url: 'https://www.nsf.gov/rss/rss_www_funding_upcoming.xml', kind: 'grant', free: true },
...
export const SOURCES = [
  { id: 'remoteok', name: 'RemoteOK', type: 'Free', url: 'https://remoteok.com/api', category: 'Remote Jobs', free: true },
  { id: 'arbeitnow', name: 'Arbeitnow', type: 'Free', url: 'https://www.arbeitnow.com/api/job-board-api', category: 'Remote Jobs', free: true },
  { id: 'themuse', name: 'The Muse', type: 'Free', url: 'The Muse API', category: 'Company Profiles', free: true },
  { id: 'jobicy', name: 'Jobicy', type: 'Free', url: 'https://jobicy.com/api/v2/remote-jobs', category: 'Remote Jobs', free: true },
  { id: 'remotive', name: 'Remotive', type: 'Free', url: 'https://remotive.com/api/remote-jobs', category: 'Remote Jobs', free: true },
  ...
  { id: 'hn_hiring', name: 'HN Who is Hiring', type: 'Free', url: 'https://hn.algolia.com/api/v1/search_by_date', category: 'Tech Jobs', free: true },
